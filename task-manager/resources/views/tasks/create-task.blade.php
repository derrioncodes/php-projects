...
@section('title', 'Task Manager - Create')
            ...
            <form method="POST" action="/tasks">
                ...
                <label class="block mb-5">
                    <input
                        ...
                        id="signInInput2-1" type="text" placeholder="Task Title" autocomplete="off" name="title" value="{{old('title')}}">
                ...
                <label class="relative block mb-5">
                    <textarea
                        ...
                        id="signInInput2-2" placeholder="Description" name="description" autocomplete="off">{{old('description')}}
                    </textarea>
